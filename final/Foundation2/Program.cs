...
class Program
{
    static void Main()
    {
        ...
        // Add another product to the Canadian order
        Product product3 = new Product("Keyboard", "LJC1119", 300, 2);
        Order order2 = new Order(new List<Product> { product2, product3 }, nonUsaCustomer);
